// Notice that these don't really need to implement ProtocolSpecXYZ interfaces in api/core/protocol, as TS uses duck typing to check for type equality.
...
export type ID = string; // TODO use protocol.Encoded<UUID, string> here. Branded types do not go well with generic non-brand-aware code.
